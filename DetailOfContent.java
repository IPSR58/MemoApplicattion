...
/**
 * Servlet implementation class detailofcontent
 */
@WebServlet("/DetailOfContent")
public class DetailOfContent extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DetailOfContent() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*編集ボタンが押下された場合の処理*/
		if("true".equals(request.getParameter("edit_memo"))) {
